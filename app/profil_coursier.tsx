  ...
  return (
    <>
      <ScrollView contentContainerStyle={styles.container}>
        ...
        <View style={styles.header}>
          ...
          <View style={styles.statsBox}>
            <Text style={styles.statsItem}>
              {" "}
              {coursier.stats.livraisons} Livraisons
            </Text>
            <Text style={styles.statsItem}>
              {" "}
              {coursier.stats.note} Note moy.
            </Text>
            <Text style={styles.statsItem}>
              {" "}
              {coursier.stats.completion} Complétion
            </Text>
          </View>
        </View>
        ...
        <View style={styles.sectionBox}>
          ...
          <TouchableOpacity style={styles.button}>
            <Text>✏️ Modifier profil</Text>
          </TouchableOpacity>
          <TouchableOpacity style={styles.button}>
            <Text>📞 {coursier.telephone}</Text>
          </TouchableOpacity>
          <TouchableOpacity
            style={styles.button}
            onPress={() =>
              router.push({
                pathname: "/notification_coursier",
                params: { id: "course_001" },
              })
            }
          >
      ...
      <View style={styles.navBar}>
        <TouchableOpacity onPress={() => router.push("/dashboard_coursier")}>
          <Text>🏠 Accueil</Text>
        </TouchableOpacity>
