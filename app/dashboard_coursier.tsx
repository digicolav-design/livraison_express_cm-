...
export default function DashboardCoursier() {
  ...
  const [stats, setStats] = useState({ deliveries: 0, gains: 0, note: 0 });
  const [deliveries, setdeliveries] = useState<Course[]>([]);
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      // récupérer commandes du coursier
  ...
  return (
    <>
        ...
        <View style={styles.header}>
          <View style={styles.headerLeft}>
            <TouchableOpacity
              style={[
                styles.statusBtn,
                { backgroundColor: online ? "#414143" : "#C0392B" },
              ]}
              ...
              <View style={styles.statusRow}>
                <Animated.View
                  style={[
                    styles.blinkDot,
                    {
                      backgroundColor: online ? "#27AE60" : "#C0392B",
                      opacity: blinkAnim,
                    },
                  ]}
                />
      ...
      <View style={styles.navbar}>
        ...
        <TouchableOpacity onPress={() => router.push("/profil_coursier")}>
          <Text>👤 Profil</Text>
        </TouchableOpacity>
        <TouchableOpacity onPress={() => router.push("/#")}>
