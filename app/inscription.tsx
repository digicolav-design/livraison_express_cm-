...
import {
  ...
  StatusBar, SafeAreaView, TextInput, Modal, FlatList,
} from 'react-native';
...
export default function InscriptionScreen() {
  ...
  const handleSoumettre = () => {
    // On marque comme soumis pour afficher les erreurs
    setSoumis(true);
    if (formulaireValide) {
  ...
  return (
    <SafeAreaView style={styles.container}>
          ...
          <View style={styles.modalBox}>
            ...
            <FlatList
              ...
              renderItem={({ item }) => {
                ...
                return (
                  <TouchableOpacity
                    style={[styles.paysItem, estSelectionne && styles.paysItemSelected]}
                    onPress={() => {
                  ...
                  >
                    ...
                    <Text style={[styles.paysNom, estSelectionne && styles.paysNomSelected]}>
                      {item.nom}
                    </Text>
                    <View style={[styles.paysCodeBadge, estSelectionne && styles.paysCodeBadgeSelected]}>
                      <Text style={[styles.paysCode, estSelectionne && styles.paysCodeSelected]}>
                        {item.code}
                      </Text>
                    </View>
      ...
      >
        ...
        {soumis && !nomValide && (
          <Text style={styles.erreurMsg}>⚠️ Veuillez entrer votre nom complet</Text>
        )}
        ...
        {soumis && !emailValide && (
          <Text style={styles.erreurMsg}>⚠️ Veuillez entrer un email valide</Text>
        )}
        ...
        {soumis && !telValide && (
          <Text style={styles.erreurMsg}>⚠️ Veuillez entrer un numéro valide</Text>
        )}
        {telephone.length > 0 && (
        ...
        {soumis && !genreValide && (
          <Text style={styles.erreurMsg}>⚠️ Veuillez sélectionner votre genre</Text>
        )}
        ...
        <TouchableOpacity
          style={[
            styles.btnBlue,
            !formulaireValide && styles.btnBlueDisabled,
          ]}
...
const styles = StyleSheet.create({
  ...
  modalResultCount: {
    ...
    paddingHorizontal: 18, marginBottom: 4, fontWeight: '500',
  },
  paysItem: {
  ...
  avatarCircle: {
    ...
    borderWidth: 2, borderColor: '#0A2FCC',
    borderStyle: 'dashed',
  ...
  inputRow: {
    flexDirection: 'row', alignItems: 'center',
    backgroundColor: '#F9FAFB',
    borderWidth: 1.5, borderColor: '#E5E4DF',
    borderRadius: 12, overflow: 'hidden',
  },
  inputRowFocused: {
    borderColor: '#0A2FCC', backgroundColor: '#fff',
    shadowColor: '#0A2FCC', shadowOffset: { width: 0, height: 2 },
  ...
  flagBtn: {
    flexDirection: 'row', alignItems: 'center',
    paddingHorizontal: 11, paddingVertical: 13,
    backgroundColor: '#EEF2FF', gap: 5,
  },
  ...
  phoneInput: {
    flex: 1, paddingHorizontal: 13, paddingVertical: 13,
    fontSize: 15, fontWeight: '600', color: '#111827', letterSpacing: 0.5,
  },
  previewBox: {
    backgroundColor: '#F0FDF4', borderRadius: 8,
    paddingHorizontal: 12, paddingVertical: 7,
    marginTop: 7, borderWidth: 1, borderColor: '#BBF7D0',
  },
  ...
  // ── Bouton ──
  btnBlue: {
    backgroundColor: '#0A2FCC', borderRadius: 13,
