...
export default function AccueilClientScreen() {
  ...
  useEffect(() => {
    const getUser = async () => {
      ...
      // Chercher son nom dans la table users
      ...
      if (data && data.full_name) {
        // Afficher uniquement le prénom (premier mot)
    ...
    <SafeAreaView style={styles.container}>
      ...
      >
        ...
        <View style={styles.catGrid}>
          {CATEGORIES.map((cat) => (
            <TouchableOpacity
              ...
              onPress={() => router.push("/passer-commande")}
            >
              {cat.badge && (
        ...
        <TouchableOpacity
          ...
          onPress={() => router.push("/inscription_coursier" as any)}
          activeOpacity={0.85}
        >
